...
export const getAllTracking = async (req: Request, res: Response) => {
    try {
...
export const getLatestTrackingByTechnician = async (req: Request, res: Response) => {
    try {
...
export const updateTracking = async (req: Request, res: Response) => {
    try {
        ...
        // Update fields
        if (latitude !== undefined) tracking.latitude = latitude;
        if (longitude !== undefined) tracking.longitude = longitude;
        if (address !== undefined) tracking.address = address;
...
export const getTrackingNearby = async (req: Request, res: Response) => {
    try {
